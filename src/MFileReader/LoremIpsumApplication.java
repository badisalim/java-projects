...
public class LoremIpsumApplication {
    ...
    private static void readDocument(FileReader reader) {
        ...
        List<String> lines = reader.asLines("MFileReader/TextFile");
...
//        List<String> lines = reader.getLines("MFileReader/TextFile");
//        for (String line : lines) {
...
//        List<String> lines = reader.getLines("MFileReader/TextFile.csv");
